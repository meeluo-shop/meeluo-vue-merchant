...
!(function (t) {
  ...
  var T,
    ...
    V = function (t, e) {
      var n = it(t),
        ...
        s =
          a &&
          W(a.marginLeft) + W(a.marginRight) + o.getBoundingClientRect().width,
        c =
          l &&
          W(l.marginLeft) + W(l.marginRight) + r.getBoundingClientRect().width;
  ...
  function K(t, e) {
    if (!t || !t.nodeType || 1 !== t.nodeType)
      throw (
        "Sortable: `el` must be HTMLElement, and not " + {}.toString.call(t)
      );
    ...
    null == e.invertedSwapThreshold &&
      (e.invertedSwapThreshold = e.swapThreshold),
    this))
      "_" === o.charAt(0) &&
    ...
    (this.nativeDraggable = !e.forceFallback && p),
      ...
      this.nativeDraggable &&
        (tt(t, "dragover", this), tt(t, "dragenter", this)),
  ...
  function $(t, e, n, i) {
    if (t) {
      n = n || f;
      do {
        if ((">*" === e && t.parentNode === n) || ft(t, e) || (i && t === n))
          return t;
        if (t === n) break;
      } while (
        (t = (o = t).host && o !== f && o.host.nodeType ? o.host : o.parentNode)
      );
    }
    var o;
    return null;
  ...
  return (
    (K.prototype = {
        ...
        if (
          ...
          if (((e = ut(s, o.draggable)), "function" == typeof d)) {
            ...
            (d = d.split(",").some(function (t) {
              if ((t = $(c, t.trim(), i, !1)))
                return rt(n, t, "filter", s, i, i, e), !0;
            }))
          )
            return void (r && t.cancelable && t.preventDefault());
          (o.handle && !$(c, o.handle, i, !1)) ||
        ...
        n &&
          ...
          l.delay
            ? (tt(s, "mouseup", r._disableDelayedDrag),
              ...
              l.supportPointer &&
                tt(s, "pointermove", r._delayedDragTouchMoveHandler),
      ...
      _dragStarted: function () {
        if (A && T) {
          this.nativeDraggable &&
            (tt(f, "dragover", this._handleAutoScroll), tt(f, "dragover", J));
          var t = this.options;
          nt(T, t.dragClass, !1),
            nt(T, t.ghostClass, !0),
            it(T, "transform", ""),
      ...
      _emulateDragOver: function (t) {
        if (C) {
          if (this._lastX === C.clientX && this._lastY === C.clientY && !t)
            return;
          (this._lastX = C.clientX),
            (this._lastY = C.clientY),
            g || it(E, "display", "none");
          for (
            var e = f.elementFromPoint(C.clientX, C.clientY),
              n = e,
              i = !!$(e, null, T, !0);
            e && e.shadowRoot;
      ...
      _onTouchMove: function (t) {
        if (u) {
          ...
          if (!K.active) {
            if (
              n &&
              m(z(o.clientX - this._lastX), z(o.clientY - this._lastY)) < n
            )
              return;
            this._dragStarted();
          }
          ...
          e
            ? ("touch" === e
                ? (tt(f, "touchmove", bt),
                  ...
                  o.supportPointer &&
                    (tt(f, "pointermove", n._onTouchMove),
                    tt(f, "pointerup", n._onDrop)))
                : (tt(f, "mousemove", n._onTouchMove),
                  tt(f, "mouseup", n._onDrop)),
              (n._loopId = setInterval(n._emulateDragOver, 50)),
              nt(T, o.dragClass, !1))
            : (i &&
                ((i.effectAllowed = "move"),
                o.setData && o.setData.call(n, i, T)),
              tt(f, "drop", n),
      ...
      _onDragOver: function (t) {
        ...
        if (
          ...
          void 0 !== t.preventDefault &&
            (t.cancelable && t.preventDefault(),
            !p.dragoverBubble && t.stopPropagation()),
          (X = !0),
          ...
          !((T.animated && e === T) || e.animated || j) &&
            ...
            v &&
              ...
              (m
                ? _ || (o = !A.contains(T))
                : P === this ||
                  ((this.lastPutMode = N.checkPull(this, v, T, t)) &&
                    g.checkPut(this, v, T, t)))))
        ) {
          var b,
          ...
          if (
            ...
            !e.animated &&
            e !== T &&
            void 0 !== e.parentNode[L] &&
            e !== f
          ) {
            if (
              ((O =
                O || p.invertSwap || T.parentNode !== f || !this._isAligned),
              0 ===
            ...
            !1 !== C &&
              ...
              T.contains(f) ||
                (D && !y
                  ? f.appendChild(T)
                  : e.parentNode.insertBefore(T, D ? y : e)),
              (S = T.parentNode),
              this._animate(n, T),
              this._animate(i, e));
          }
      ...
      _nulling: function () {
        (A = T = S = E = B = x = h = w = y = I.length = l = s = d = u = C = X = i = c = Y = k = R = P = N = K.active = null),
      ...
      toArray: function () {
        for (
          ...
          $((t = n[i]), r.draggable, this.el, !1) &&
            e.push(t.getAttribute(r.dataIdAttr) || ht(t));
        return e;
      },
      sort: function (t) {
        var i = {},
