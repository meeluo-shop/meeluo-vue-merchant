<template>
  ...
  >
    <el-form ref="form" :model="form" :rules="rules" label-width="auto">
      ...
      <el-form-item required label="运费金额">
        <el-input-number
...
<script>
  import { updateOrderPrice } from "@/api/orderlogistics";
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          ...
          express_price: [
            { required: true, trigger: "blur", message: "请输入运费金额" },
          ],
        },
    ...
    methods: {
      async showEdit(row) {
        ...
        this.form.express_price = row.express_price;
